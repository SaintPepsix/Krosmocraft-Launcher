...
public class LauncherBase {
	...
	private static boolean firstTimeUwU = true;
	/**
	 * The Constructor
	...
	public LauncherBase(final Stage stage, Scene scene, StageStyle style, GameEngine engine) {
		...
		if (firstTimeUwU && (OperatingSystem.getCurrentPlatform() == OperatingSystem.OSX || OperatingSystem.getCurrentPlatform() == OperatingSystem.LINUX || OperatingSystem.getCurrentPlatform() == OperatingSystem.SOLARIS)) {
	...
	private void displayCopyrights() {
		if (firstTimeUwU){
			Logger.log("========================================");
			Logger.log("|           Launcher Krosmocraft       |");
